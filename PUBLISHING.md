...
This guide explains how to publish `maplibre-gl-layer-control-tidop` to npm.
...
```bash
npm search maplibre-gl-layer-control-tidop
```

If the name is taken, you'll need to either:
- Choose a different name
- Use a scoped package: `@yourusername/maplibre-gl-layer-control-tidop`
...
- `maplibre-gl-layer-control-tidop.css` - Styles
...
# This creates maplibre-gl-layer-control-tidop-0.1.0.tgz

# In another project
npm install /path/to/maplibre-gl-layer-control-tidop-0.1.0.tgz
```
...
```bash
npm view maplibre-gl-layer-control-tidop
```

Or visit: https://www.npmjs.com/package/maplibre-gl-layer-control-tidop
